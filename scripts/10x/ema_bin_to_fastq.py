...
if __name__ == '__main__':
    ...
    group_required.add_argument('-i', '--input', type=str, help="input file ema-bin-xxx (use '-' for STDIN)")
    group_required.add_argument('-p', '--prefix', type=str, help='output files prefix')
    group_additional = parser.add_argument_group('Additional options')
    group_additional.add_argument('-c', '--compressed', action='store_true', help='Flag. if your input is compressed (file.gz)')
    group_additional.add_argument('-b', '--buffering', metavar='INT', type=int, default=None, help='Text buffering. Default = None')
