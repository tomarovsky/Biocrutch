...
def main():
    ...
    sns.violinplot(data=result, x="id", y="density", hue="Reference", split = True, gap=1, scale='width', inner='box', inner_kws=dict(box_width=5, whis_width=5, color=".8"), linewidth=0.8, saturation=1, flierprops={'marker':'o', 'markersize':1}, boxprops={'alpha' : 1}, palette=args.colors_list)
