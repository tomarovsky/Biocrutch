...
def main():
    ...
    sns.violinplot(data=result, x="id", y="density", hue="Reference", split = True, scale='width', inner='box', inner_kws=dict(box_width=1.4, whis_width=0, marker = '.', markersize=2.2, markeredgewidth=0.6), linewidth=1.3, saturation=1, palette=args.colors_list)
