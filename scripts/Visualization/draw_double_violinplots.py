...
def main():
    ...
    sns.violinplot(data=result, x="id", y="density", hue="Reference", split = True, scale='width', inner='box', inner_kws=dict(box_width=0.8, whis_width=0, markersize=5), linewidth=0.7, saturation=1, palette=args.colors_list)
